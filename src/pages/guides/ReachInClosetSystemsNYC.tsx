...
const DESC =
  "How a Brooklyn cabinetmaker designs reach-in closet systems for NYC apartments: standard depths, the four-zone layout, and what it costs.";
      ...
      <section className="py-16 sm:py-20 md:py-28">
        <div className="container mx-auto px-4 sm:px-6 max-w-3xl">
          <h2 className="text-2xl sm:text-3xl font-bold mb-3 flex items-center gap-2">
            <Ruler className="h-6 w-6 text-accent-foreground" /> Standard NYC reach-in dimensions
          </h2>
          ...
          <ul className="list-disc pl-5 space-y-2 text-base text-muted-foreground">
            <li><Link to="/double-sink-vanity-guide" className="text-accent-foreground hover:underline">Double sink vanity guide</Link></li>

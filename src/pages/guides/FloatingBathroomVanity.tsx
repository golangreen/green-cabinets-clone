        ...
        <div className="container mx-auto px-4 sm:px-6 max-w-3xl">
          ...
          <div className="grid sm:grid-cols-2 gap-6 mb-12">
            <div className="border border-border rounded-lg p-5">
              <h3 className="font-bold text-foreground mb-3 flex items-center gap-2"><Check className="h-5 w-5 text-[#5C7650]" /> Pros</h3>
              <ul className="space-y-2 text-sm text-muted-foreground">
                {PROS.map((p) => <li key={p} className="flex gap-2"><span className="text-[#5C7650]">·</span>{p}</li>)}
              </ul>
            </div>
            <div className="border border-border rounded-lg p-5">
          ...
          <ul className="list-disc pl-5 space-y-2 text-base text-muted-foreground">
            <li><Link to="/double-sink-vanity-guide" className="text-[#5C7650] hover:underline">Double sink vanity sizing & layouts</Link></li>

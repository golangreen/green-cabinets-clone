          ...
          <div className="grid md:grid-cols-2 gap-6">
            {CASE_STUDIES.map((c) => (
              ...
              >
                ...
                <div className="p-6">
                  <p className="text-xs uppercase tracking-wider text-accent-foreground font-semibold mb-2">
                    {c.neighborhood}, {c.borough} · {c.year}
                  </p>
                  <h2 className="text-xl font-bold text-foreground mb-2 group-hover:text-accent-foreground transition-colors">
                    {c.title}
                  </h2>

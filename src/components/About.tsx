const About = () => {
  return (
    <section id="about" className="py-16 sm:py-20 md:py-28 lg:py-32 bg-background">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <div className="space-y-6 text-lg text-[#666666] leading-relaxed">
            ...
            <p>
              ...
              <span className="text-[#1a1a1a] font-semibold"> pride in our craftsmanship</span>, 
            ...
            <p className="text-xl font-semibold text-[#1a1a1a] pt-4">

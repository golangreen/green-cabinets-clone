            ...
            >
              ...
              {borough.neighborhoods.length > DEFAULT_VISIBLE && (
                <button
                  ...
                  className="self-start mb-4 text-xs font-semibold text-accent-foreground hover:text-accent-foreground transition-colors"
                >
                  {expanded[borough.slug]
                    ? "Show fewer"
              ...
              <div className="mt-auto flex flex-col gap-2">
                <Link
                  to={boroughHref}
                  className="inline-flex items-center justify-center gap-1 text-sm font-semibold text-accent-foreground hover:text-accent-foreground transition-colors"
                >

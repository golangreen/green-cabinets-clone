...
export const WOOD_SPECIES: WoodSpecies[] = [
  {
    ...
    longDescription: [
      ...
      "**Cost in NYC.** Painted maple shaker cabinets from Green Cabinets NY run roughly $350 per linear foot for a kitchen. That makes maple one of the best price-to-quality plays in the city. Compared to a paint-grade hybrid (poplar frames + MDF panels), maple costs 10–15% more. The upgrade buys you a true all-hardwood door that resists denting from kid backpacks, dog tails, and dropped pans. Versus walnut at the high end, maple lands at roughly half the cost for a similarly built door — most of the savings come from raw lumber yield, not workmanship.",
    ...
    metaTitle: "Maple Kitchen Cabinets NYC — Painted, Natural, Shaker",
    metaDescription:
    ...
    faqHeading: "Maple Cabinet FAQs — Paint, Cost, Durability & Care",
    ...
    faqOgDescription:
      "Quick answers on painting hard maple, pricing per linear foot, daily durability, and finish care — from a Brooklyn-based custom cabinetry company designing kitchens since 2009.",
  },
  {
    slug: "walnut",
    ...
    longDescription: [
      ...
      "Cost in the NYC market currently runs $14-$18 per board foot for FAS-grade walnut, making it the most expensive common domestic cabinet hardwood — roughly 2-3× the cost of maple and 30-50% more than white oak. For a typical 30-linear-foot custom kitchen, expect walnut cabinetry to run $30,000-$45,000 through our Brooklyn-based design process, depending on door style, finish, and hardware selection.",
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Custom walnut cabinets specified through our Brooklyn-based design process typically run $30,000-$45,000 for a 30-linear-foot kitchen depending on door style, finish, and hardware. Lumber alone runs $14-$18 per board foot for FAS-grade walnut. Many clients specify walnut only for the island and vanities, with white oak or maple for the perimeter.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Plan on 10-12 weeks for custom walnut cabinets versus 6-8 weeks for red oak or maple. Walnut supply has stabilized post-pandemic but lead times remain longer than other domestic species due to careful color sorting required to manage sapwood-heartwood contrast.",
      },
    ],
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Custom plain-sawn white oak cabinets typically run $20,000-$30,000 for a 30-linear-foot kitchen. Rift-cut adds roughly $2,500-$4,000, quartersawn adds $5,000-$8,000. Lumber alone runs $10-$12 per board foot for plain-sawn, $14-$18 for rift, $18-$24 for quartersawn.",
      },
      {
  ...
  },
  {
    ...
    longDescription: [
      ...
      "**Finish options we build in.** Clear hardwax oil over rift-cut for a matte Scandinavian read; limed or cerused white where you want the grain to show as texture, not color; honey and amber pigment stains for mid-century warmth; espresso and gray dye stains when the pink undertone needs to be neutralized (dye first, pigment second — pigment alone leaves the pores pinker than the field); and grain-filled paint for clients who want oak texture under a color. Sheen matters as much as color: 10–20% matte hides the open pore, while satin and above make it glint. Every red oak job includes door samples finished from the same batch our supplier will use, so what you approve is what ships.",
      "**Custom red oak cabinetry in NYC.** We design red oak kitchens, islands, vanities, and built-ins to the exact opening — no filler strips, no stock sizes — built by our vetted millwork suppliers, with delivery and install across Brooklyn, Queens, Manhattan, the Bronx, and Staten Island. Typical scope runs $350 per linear foot for kitchen cabinetry, with a 6–8 week lead time that beats white oak by two weeks and rift-cut by up to six.",
    ],
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Custom red oak cabinets typically run $12,000-$20,000 for a 30-linear-foot kitchen depending on door style, finish, and hardware. That makes red oak the best value in custom solid-wood cabinetry — significantly less than walnut, white oak, or rift-cut alternatives.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Yes. Green Cabinets NY designs red oak kitchens, islands, vanities, and built-ins to the exact opening, built by our vetted millwork suppliers, with delivery and installation across Brooklyn, Queens, Manhattan, the Bronx, and Staten Island. Kitchen cabinetry runs about $350 per linear foot with a 6-8 week lead time.",
      },
    ],
  ...
  },
  {
    ...
    longDescription: [
      ...
      "Birch plywood is the gold standard for cabinet boxes and drawer interiors in the U.S. — it sands flat, takes screws and glue exceptionally well, and is dimensionally stable enough for full-depth shelving. Most American cabinetry companies, including the suppliers we specify, build cases out of either Baltic birch or domestic prefinished birch ply.",
  ...
  },
  {
    ...
    longDescription: [
      ...
      "Working with rustic hickory requires planning. The wood is dense, hard on tooling, and prone to splitting if pre-drilled inadequately — we specify sharper bits and slower feed rates than for maple work. Color sorting takes longer because the goal is intentional variation, not consistency. Expect 10-15% more fabrication time than for clean-grade material, which we factor into pricing.",
